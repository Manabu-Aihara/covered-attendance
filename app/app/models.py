...
class D_JOB_HISTORY(db.Model):
    ...
    def __init__(self, STAFFID, JOBTYPE_CODE, CONTRACT_CODE, PART_WORKTIME, START_DAY, END_DAY):
        self.STAFFID = STAFFID
        self.JOBTYPE_CODE = JOBTYPE_CODE
        self.CONTRACT_CODE = CONTRACT_CODE
...
class Shinsei(db.Model):
    ...
    def __init__(self, STAFFID, WORKDAY, HOLIDAY, STARTTIME, ENDTIME, MILEAGE,
                 ONCALL, ONCALL_COUNT, ENGEL_COUNT, NOTIFICATION, NOTIFICATION2, OVERTIME, ALCOHOL, REMARK):
        self.STAFFID = STAFFID
