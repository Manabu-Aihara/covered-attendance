...
def append_approval():
    ...
    asking_message = f"「{asking_user.LNAME}　{asking_user.FNAME}」さんから届出の申請が来ています。\n\
    以下、URLから「承認/拒否」を選択して下さい。\n\
    \n\
    ...
    try:
        ...
        channel = skype_system_obj.CONTRACTs[skype_approval_account.SKYPE_ID].chat
...
def change_status_judge(id, STAFFID, status: int):
    ...
    try:
        ...
        channel = skype_system_obj.CONTRACTs[approval_wait_user.SKYPE_ID].chat
